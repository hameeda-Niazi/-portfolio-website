    ...
    <AnimatedSection>
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="rounded-[30px] bg-[#2f241d] p-8 text-white shadow-[0_20px_60px_rgba(70,52,40,0.16)]">
            <p className="text-sm uppercase tracking-[0.28em] text-[#f5d3be]">About Me</p>
            <h2 className="mt-4 text-3xl font-bold tracking-tight">A thoughtful frontend developer with a product-first eye.</h2>
          </div>
